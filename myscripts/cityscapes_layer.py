...
# Adapted from: Fully Convolutional Networks for Semantic Segmentation by Jonathan Long*, 
#               Evan Shelhamer*, and Trevor Darrell. 
#               CVPR 2015 and PAMI 2016. http://fcn.berkeleyvision.org
...
class CityscapesDataLayer(caffe.Layer):
	...
	# import cityscapes label helper and set up label mappings
        ...
        split_f  = '{}/{}.txt'.format(self.cityscapes_dir, self.split)
